#' Compute b-star for given genome regions
#'
#' This function compute the b-star for a given genome regions within a given ethnicity group.
#' 
...
#' 
#' @export
b_star_regional_prod <- function(pop_list, chr_id, pos_sta, pos_end){
  dat_out <- data.frame()
  for(pop in pop_list){
